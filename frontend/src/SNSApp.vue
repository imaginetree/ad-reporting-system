        ...
        <div>
            ...
            <v-navigation-drawer app clipped flat v-model="sideBar">
                <v-list>
                    <v-list-item
                        class="px-2"
                        key="adRecordingManagements"
                        to="/adRecordingManagements/adRecordingManagements"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        class="px-2"
                        key="reportListManagements"
                        to="/adReportings/reportListManagements"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
...
export default {
    ...
    data: () => ({
        ...
        aggregate: [
            { 
                title: 'AdRecordingManagement', 
                description: '', 
                key: 'adRecordingManagements', 
                route: '/adRecordingManagements/adRecordingManagements',
                ImageUrl: '',
            },
            { 
                title: 'ReportListManagement', 
                description: '', 
                key: 'reportListManagements', 
                route: '/adReportings/reportListManagements',
                ImageUrl: '',
            },
